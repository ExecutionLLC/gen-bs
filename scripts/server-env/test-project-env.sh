...
# Frontend
export GEN_FRONTEND_API_HOST=ec2-54-152-39-59.compute-1.amazonaws.com
...
export GEN_WS_RABBIT_MQ_REQUEST_EXCHANGE='test-genomics-exchange'

export GEN_WS_LOG_PATH=$HOME/logs/web-server.log
export GEN_WS_USER_SESSION_TIMEOUT=900
export GEN_WS_BASE_URL='http://ec2-54-152-39-59.compute-1.amazonaws.com'
