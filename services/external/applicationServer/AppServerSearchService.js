...
class AppServerSearchService extends ApplicationServerServiceBase {
    ...
    loadResultsPage(user, session, operationId, limit, offset, callback) {
        ...
        async.waterfall([
            ...
            (operation, callback) => this._rpcSend(operation, method, searchDataRequest, null, callback)
        ], callback);
    }
    ...
    requestOpenSearchSession(session, params, callback) {
        ...
        async.waterfall([
            ...
            (operation, callback) => this._rpcSend(operation, method, searchSessionRequest, null, callback)
        ], callback);
    }
    ...
    requestSearchInResults(session, operationId, params, callback) {
        async.waterfall([
            ...
            (operation, callback) => {
                ...
                this._rpcSend(operation, METHODS.searchInResults, setFilterRequest, null,
