...
class InitialDataImportManager {
    ...
    _importUsers(usersFilePath, callback) {
        ...
        async.map(users, (user, cb) => {
            this._addUser(user, user.language,false, cb)
        }, callback);
    }
    ...
    _importKeywords(keywordsFilePath, callback) {
        ...
        async.map(keywords, (keyword, cb) => {
            this._addKeyword(keyword, false, cb);
        }, callback);
    }
    ...
    _importViews(viewsFilePath, callback) {
        ...
        async.map(views, (view, cb) => {
            this._addView(null, this.config.defaultLanguId, view, false, cb);
        }, callback);
    }
    ...
    _importFilters(filtersFilePath, callback) {
        ...
        async.map(filters, (filter, cb) => {
            this._addFilter(null, this.config.defaultLanguId, filter, false, cb);
        }, callback);
    }
    ...
    _importSample(sampleMetadataFilePath, callback) {
        ...
        this._addSample(null, this.config.defaultLanguId, sampleWithFields.sample, false, callback);
    }
    ...
    _importMetadata(fieldsMetadata, callback) {
        async.map(fieldsMetadata, (fieldMetadata, cb) => {
            this._addField(this.config.defaultLanguId, fieldMetadata, false, cb)
        }, callback);
    }
    ...
    _addFilter(userId, languId, filter, shouldGenerateId, callback) {
    ...
    _addSample(userId, languId, sample, shouldGenerateId, callback) {
        this.db.transactionally((trx, callback) => {
            async.waterfall([
                (callback) => {
                    const dataToInsert = {
    ...
    _addView(userId, languId, view, shouldGenerateId, callback) {
        this.db.transactionally((trx, callback) => {
    ...
    _addUser(user, languId, shouldGenerateId, callback){
    ...
    _addKeyword(keyword, shouldGenerateId, callback) {
        this.db.transactionally((trx, callback) => {
            async.waterfall([
    ...
    _addField(languId, metadata, shouldGenerateId, callback) {
        this.db.transactionally((trx, callback) => {
