...
describe('Immutable array', () => {
    it('should replace item', () => {
        ...
        expect(immutableArray.replace([], 3, 123)).toEqual([]);
        expect(immutableArray.replace([11, 22, 33], -1, 123)).toEqual([11, 22, 33]);
        ...
        expect(immutableArray.replace([11, 22, 33], 4, 123)).toEqual([11, 22, 33]);
    });
    it('should remove item', () => {
        expect(() => immutableArray.remove(null, 3)).toThrow();
        expect(immutableArray.remove([], 3)).toEqual([]);
        expect(immutableArray.remove([11, 22, 33], -1)).toEqual([11, 22, 33]);
