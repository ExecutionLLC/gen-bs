            ...
            return (
                <div className="panel file-upload-panel panel-default">
                    <div className="panel-body">
                        ...
                        <button onClick={this.uploadClickHandler.bind(this)} data-target="#fileOpen" data-toggle="modal"
                        ...
                        { isArchiving &&
                        <div className="text-center"><strong style={{color: '#2363a1'}}>Archiving...</strong><i
