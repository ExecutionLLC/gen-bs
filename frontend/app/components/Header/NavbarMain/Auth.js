...
export default class Auth extends Component {
    _renderForAuthorizedUser() {
        return (
            <div data-toggle='tooltip' data-localize='account.help' data-placement='left' title={AUTHORIZED_USER_TITLE}
                 data-container='body' data-trigger='hover' className='hidden-xs hidden-xss'>
                <div className='dropdown'>
                    <a href='#' className='btn navbar-btn dropdown-toggle' data-toggle='dropdown'
    ...
    _renderForDemoUser() {
        return (
            <div data-toggle='tooltip' data-localize='account.help' data-placement='left' title={DEMO_USER_TITLE}
                 data-container='body' data-trigger='hover' className='hidden-xs hidden-xss'>
                <a href={config.LOGIN_URL} className='btn navbar-btn dropdown-toggle' data-toggle='collapse'
                   data-target='#sidebarRight'>
                    <span className='guest' data-localize='account.login.title'>
                        Login
