export default {
    ...
    samples: {
        ...
        rightPaneError: {
            title: 'Ошибка! ',
            description: {
                file: 'Файл не загружен или поврежден',
                sample: 'Сэмпл не загружен или поврежден'
            }
        },
        rightPaneWait: {
            title: 'Ожидайте. ',
        ...
        errors: {
            ...
            deleteSampleError: 'Нам действительно жаль, но произошла ошибка во время удаления сэмпла. ' +
                'Уверяем, что мы работаем над разрешением этой проблемы. Вы также можете обновить эту страницу и попробовать еще раз.',
            unsupportedFileFormat: 'Не поддерживаемый формат файла: должен быть Variant Call Format' +
                ' (VCF) версии 4.1 или выше, или VCF, сжатый gzip-ом'
        }
    },
    demoPopup: {
    ...
    analysis: {
        ...
        rightPane: {
            ...
            content: {
                ...
                analyzeTitle: 'Нажмите для анализа с выбранными начальными версиями фильтра и представления',
    ...
    view: {
        ...
        validationMessage: {
            nameAlreadyExists: 'Представление с таким именем уже существует.',
            empty: 'Имя не должно быть пустым',
            lengthExceeded: 'Длина имени может быть не более %{maxLength}'
        }
    },
    historyEntity: '%{name} (архивный)'
};
