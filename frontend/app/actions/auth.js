...
export const IS_WAITING_FOR_CLOSE_ANOTHER_PAGE_OPENED_MODAL = 'IS_WAITING_FOR_CLOSE_ANOTHER_PAGE_OPENED_MODAL';
...
export function setWaitStateForModal() {
    return {
        type: IS_WAITING_FOR_CLOSE_ANOTHER_PAGE_OPENED_MODAL
    };
}
